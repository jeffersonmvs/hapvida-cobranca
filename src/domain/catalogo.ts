...
export const CATALOGO_ELETIVA: ItemCatalogo[] = [
  ...
  // Do contrato hernia (aditivo de 01/08/2025). Nao constam na planilha do
  // servico, mas sao codigos contratados - podem aparecer num boletim.
  { codigo: '31009085', nomes: ['Hernia crural'], nomeOperadora: 'Herniorrafia crural - unilateral' },
  { codigo: '31009140', nomes: ['Hernia recidivante'], nomeOperadora: 'Herniorrafia recidivante' },
  { codigo: '31009255', nomes: ['Reconstrucao de parede abdominal com retalho muscular'], nomeOperadora: 'Reconstrucao da parede abdominal com retalho muscular ou miocutaneo' },
  // Do contrato Medisa 2019, Anexo II.
  { codigo: '31005470', nomes: ['Colecistectomia por videolaparoscopia (COM colangiografia)'], nomeOperadora: 'Colecistectomia com colangiografia por videolaparoscopia' },
  { codigo: '31003133', nomes: ['Cirurgia de abaixamento (qualquer tecnica)'], nomeOperadora: 'Cirurgia de abaixamento (qualquer tecnica)' },
  { codigo: '31003591', nomes: ['Cirurgia de abaixamento por videolaparoscopia'], nomeOperadora: 'Cirurgia de abaixamento por videolaparoscopia' },
  { codigo: '31303102', nomes: ['Histerectomia total'], nomeOperadora: 'Histerectomia total (via alta ou baixa)' },
  { codigo: '31003648', nomes: ['Colectomia total com ileostomia por videolaparoscopia'], nomeOperadora: 'Colectomia total com ileostomia por videolaparoscopia' },
  { codigo: '31305032', nomes: ['Ooforectomia laparoscopica'], nomeOperadora: 'Ooforectomia laparoscopica uni ou bilateral' },
  ...
  { codigo: '31003281', nomes: ['Enterectomia'], nomeOperadora: 'Enterectomia' },
  { codigo: '31003192', nomes: ['Colectomia parcial'], nomeOperadora: 'Colectomia total com ileostomia' },
