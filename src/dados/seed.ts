...
export const TABELA_HONORARIOS: Procedimento[] = [
  ...
  { codigo_tuss: '31005470', descricao: 'Colecistectomia com colangiografia por videolaparoscopia', valor_cobrar: 1056.78, valor_pago: 1056.78, glosa_recorrente: 0, confianca: 'confirmado', equivalente_a: '31005497', observacao: 'Mesma cirurgia do 31005497, mesmo valor. O codigo usado pelo servico e o 31005497.', vigencia_inicio: '2026-01-01' },
  ...
  { codigo_tuss: 'SEM-TUSS-01', descricao: 'Reconstrucao de parede abdominal com retalho muscular (aposentado - virou 31009255)', vigencia_fim: '2026-08-27', valor_cobrar: 280, valor_pago: 280, glosa_recorrente: 0, confianca: 'confirmado', exige_retalho: true, termos_exigidos: ['retalho'], codigo_interno: true, observacao: 'Codigo TUSS oficial pendente.', vigencia_inicio: '2026-01-01' },
  ...
  // --- valores dos contratos (pasta AAA HAPVIDA ELETIVAS) --------------------
  // Contrato Medisa 2019, Anexo II - codigos em CBHPM 2005 pontuado.
  { codigo_tuss: '30908094', descricao: 'Fistula arteriovenosa dos membros', valor_cobrar: 1042.24, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31005039', descricao: 'Anastomose biliodigestiva intra-hepatica', valor_cobrar: 1056.78, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31003281', descricao: 'Enterectomia', valor_cobrar: 1056.78, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31307124', descricao: 'Resseccao de tumor de parede abdominal pelvica', valor_cobrar: 1056.78, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31003192', descricao: 'Colectomia total com ileostomia', valor_cobrar: 1056.78, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '30913012', descricao: 'Disseccao de veia para colocacao de cateter central NPP ou QT', valor_cobrar: 517.14, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31003133', descricao: 'Cirurgia de abaixamento (qualquer tecnica)', valor_cobrar: 1186.38, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31003591', descricao: 'Cirurgia de abaixamento por videolaparoscopia', valor_cobrar: 1684.80, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31303102', descricao: 'Histerectomia total (via alta ou baixa)', valor_cobrar: 1056.78, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31003648', descricao: 'Colectomia total com ileostomia por videolaparoscopia', valor_cobrar: 1684.80, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31305032', descricao: 'Ooforectomia laparoscopica uni ou bilateral', valor_cobrar: 1056.78, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  // Contrato hernia, aditivo de 01/08/2025 - ja em TUSS.
  { codigo_tuss: '31009085', descricao: 'Herniorrafia crural - unilateral', valor_cobrar: 280, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31009140', descricao: 'Herniorrafia recidivante', valor_cobrar: 280, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', vigencia_inicio: '2026-01-01' },
  { codigo_tuss: '31009255', descricao: 'Reconstrucao da parede abdominal com retalho muscular ou miocutaneo', valor_cobrar: 280, valor_pago: null, glosa_recorrente: 0, confianca: 'confirmado', exige_retalho: true, vigencia_inicio: '2026-01-01' },
]
